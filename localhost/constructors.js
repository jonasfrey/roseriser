...
let o_model__o_dxffile = f_o_model({
    s_name: 'o_dxffile',
    a_o_property: [
        f_o_model_prop__default_id(s_name_prop_id),
        f_o_property('s_name', 'string', (s)=>{return s!==''}),
        f_o_property('s_type', 'string', (s)=>{return s==='profile' || s==='profile_remover' || s==='path'}),
        f_o_property('s_path_file', 'string'),
        f_o_property('s_json_a_o_entity', 'string'),
        f_o_model_prop__timestamp_default(s_name_prop_ts_created),
        f_o_model_prop__timestamp_default(s_name_prop_ts_updated),
    ]
});
...
let o_wsmsg__upload_dxf = f_o_wsmsg_def('upload_dxf', true);
let o_wsmsg__generate_scad = f_o_wsmsg_def('generate_scad', true);
