     ...
     include <BOSL2/std.scad>
                        ...
                        arc_0 = [
                [3e-16, 3.798094716167102, 0],  // center
                ...
                510  // end angle (degrees)
                        ...
                        arc_2 = [
                [8.313293868263704, -4.799682452694521, 0],  // center
                2.900635094610966,  // radius
                ...
                329.99999999999994  // end angle (degrees)
                        ...
                        arc_3 = [
                [5.801270189221936, -3.349364905389028, 0],  // center
                5.801270189221932,  // radius
                119.99999999999999,  // start angle (degrees)
                329.9999999999998  // end angle (degrees)
            ];


                        arc_4 = [
                [0, 6.698729810778069, 0],  // center
                5.801270189221932,  // radius
                ...
                450  // end angle (degrees)
                        ...
                        arc_5 = [
                [-5.801270189221934, -3.349364905389033, 0],  // center
                5.801270189221932,  // radius
                ...
                210  // end angle (degrees)
                        ...
                        arc_6 = [
                [1e-16, 9.599364905389034, 0],  // center
                2.900635094610966,  // radius
                ...
                450  // end angle (degrees)
                        ...
                        arc_7 = [
                [-8.313293868263708, -4.799682452694515, 0],  // center
                2.900635094610966,  // radius
                ...
                209.99999999999991  // end angle (degrees)
                        ...
                        arc_8 = [
                [-3.289246510180158, -1.89904735808355, 0],  // center
                2.900635094610966,  // radius
...
but_s1_v7_tangent_point_0 = [0.000000, 6.698730, 0.000000];
but_s1_v7_tangent_point_0_angle = 180.000000;
but_s1_v7_tangent_point_1 = [5.801270, -3.349365, 0.000000];
but_s1_v7_tangent_point_1_angle = 60.000000;
but_s1_v7_tangent_point_2 = [10.825318, -6.250000, 0.000000];
but_s1_v7_tangent_point_2_angle = -120.000000;
but_s1_v7_tangent_point_3 = [0.000000, 12.500000, 0.000000];
but_s1_v7_tangent_point_3_angle = -0.000000;
but_s1_v7_tangent_point_4 = [-10.825318, -6.250000, 0.000000];
but_s1_v7_tangent_point_4_angle = 120.000000;
but_s1_v7_tangent_point_5 = [-5.801270, -3.349365, 0.000000];
but_s1_v7_tangent_point_5_angle = 120.000000;

// ===== UNCONNECTED ENDPOINTS =====
// Points where entities have no connection (line/arc endpoints), with outward rotation angle
but_s1_v7_endpoint_0 = [-0.000000, 0.897460, 0.000000];
but_s1_v7_endpoint_0_angle = 360.000000;
but_s1_v7_endpoint_1 = [0.777223, -0.448730, 0.000000];
but_s1_v7_endpoint_1_angle = 600.000000;
but_s1_v7_endpoint_2 = [2.900635, 1.674682, 0.000000];
but_s1_v7_endpoint_2_angle = 30.000000;
but_s1_v7_endpoint_3 = [-2.900635, 1.674682, 0.000000];
but_s1_v7_endpoint_3_angle = 150.000000;
but_s1_v7_endpoint_4 = [-0.000000, -3.349365, 0.000000];
but_s1_v7_endpoint_4_angle = -90.000000;
but_s1_v7_endpoint_5 = [-0.777223, -0.448730, 0.000000];
but_s1_v7_endpoint_5_angle = 480.000000;
...
module but_s1_v7_place_revolve_joints_at_tangent_points(profile_for_revolve, profile_height, angle=90) {
    translate(but_s1_v7_tangent_point_0)
    rotate([0, 0, but_s1_v7_tangent_point_0_angle])
    revolve_profile_around_x(profile_for_revolve, profile_height, angle);
    translate(but_s1_v7_tangent_point_1)
    rotate([0, 0, but_s1_v7_tangent_point_1_angle])
    revolve_profile_around_x(profile_for_revolve, profile_height, angle);
    translate(but_s1_v7_tangent_point_2)
    rotate([0, 0, but_s1_v7_tangent_point_2_angle])
    revolve_profile_around_x(profile_for_revolve, profile_height, angle);
    translate(but_s1_v7_tangent_point_3)
    rotate([0, 0, but_s1_v7_tangent_point_3_angle])
    revolve_profile_around_x(profile_for_revolve, profile_height, angle);
    translate(but_s1_v7_tangent_point_4)
    rotate([0, 0, but_s1_v7_tangent_point_4_angle])
    revolve_profile_around_x(profile_for_revolve, profile_height, angle);
    translate(but_s1_v7_tangent_point_5)
    rotate([0, 0, but_s1_v7_tangent_point_5_angle])
    revolve_profile_around_x(profile_for_revolve, profile_height, angle);
}

// Module to place revolve joints at unconnected endpoints
module but_s1_v7_place_revolve_joints_at_endpoints(profile_for_revolve, profile_height, angle=180) {
    translate(but_s1_v7_endpoint_0)
    rotate([0, 0, but_s1_v7_endpoint_0_angle])
    revolve_profile_around_x(profile_for_revolve, profile_height, angle);
    translate(but_s1_v7_endpoint_1)
    rotate([0, 0, but_s1_v7_endpoint_1_angle])
    revolve_profile_around_x(profile_for_revolve, profile_height, angle);
    translate(but_s1_v7_endpoint_2)
    rotate([0, 0, but_s1_v7_endpoint_2_angle])
    revolve_profile_around_x(profile_for_revolve, profile_height, angle);
    translate(but_s1_v7_endpoint_3)
    rotate([0, 0, but_s1_v7_endpoint_3_angle])
    revolve_profile_around_x(profile_for_revolve, profile_height, angle);
    translate(but_s1_v7_endpoint_4)
    rotate([0, 0, but_s1_v7_endpoint_4_angle])
    revolve_profile_around_x(profile_for_revolve, profile_height, angle);
    translate(but_s1_v7_endpoint_5)
    rotate([0, 0, but_s1_v7_endpoint_5_angle])
    revolve_profile_around_x(profile_for_revolve, profile_height, angle);
}
...
module but_s1_v7_place_non_tangent_joints(profile) {

}

// Sweep pattern - sweeps profile along each path (lines, arcs, and circles)
module but_s1_v7_sweep_pattern(profile) {
    union() {
        // Sweep lines
...
module but_s1_v7_full_pattern(
    ...
    union() {
        but_s1_v7_sweep_pattern(sweep_profile);
        if(b_make_joints){
            but_s1_v7_place_revolve_joints_at_tangent_points(joint_profile_for_revolve, joint_profile_height, joint_angle);
        }
        if(b_make_endpoint_joints){
            but_s1_v7_place_revolve_joints_at_endpoints(joint_profile_for_revolve, joint_profile_height, endpoint_joint_angle);
        }
        if(b_make_non_tangent_joints){
            but_s1_v7_place_non_tangent_joints(sweep_profile);
        }
    }
}
...
//but_s1_v7_sweep_pattern(profile_default(scalefactor=0.2));
