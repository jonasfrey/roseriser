...
// Entities: 0 lines, 0 arcs, 4 circles
...
circle_0 = [[3.962341, -2.287659], 7.924682];
circle_1 = [[-3.962341, -2.287659], 7.924682];
circle_2 = [[0.000000, 4.575318], 7.924682];
circle_3 = [[0.000000, 0.000000], 12.500000];
...
module but_s1_v3_place_revolve_joints_at_tangent_points(profile_for_revolve, profile_height, s=1, angle=90) {

}

// Module to place revolve joints at unconnected endpoints (with scaling)
module but_s1_v3_place_revolve_joints_at_endpoints(profile_for_revolve, profile_height, s=1, angle=180) {

}

// ===== ORNAMENT SWEEP PATTERN =====
// Sweep all ornament entities with given profile at scale s
module but_s1_v3_sweep_pattern_button_generator(profile, s=1) {
    union() {
        // Sweep lines
    ...
    difference() {
        union() {
            ...
            difference() {
                union() {
                    color("gold")
                    but_s1_v3_sweep_pattern_button_generator(
                    ...
                    color("gold")
                    but_s1_v3_place_revolve_joints_at_tangent_points(
                    ...
                    color("gold")
                    but_s1_v3_place_revolve_joints_at_endpoints(
                        p_4_for_revolve_scaled(s=n_scl_profile),
                        p_4_height * n_scl_profile,
                        s=s,
                        angle=180
