...
// Original ornament radius: 52.404mm
// Entities: 1 lines, 3 arcs, 1 circles
// Hole markers: 0 (circles with diameter 1.123mm)
...
circle_0 = [[0.000000, 10.085234], 20.170467];
arc_0 = [[0.000000, 0.000000], 17.468137, 0.000000, 180.000000];
arc_1 = [[-17.468137, 0.000000], 34.936274, 0.000000, 60.000000];
line_0 = [[-17.468137, 0.000000], [17.468137, 0.000000]];
arc_2 = [[17.468137, 0.000000], 34.936274, 120.000000, 180.000000];

// Original radius for scaling calculations
n_radius__original = 52.404411;
...
tangent_point_0 = [17.468137, 0.000000, 0];
tangent_point_0_angle = 90.000000;
tangent_point_1 = [-17.468137, 0.000000, 0];
tangent_point_1_angle = 90.000000;
...
module test_sweep_place_revolve_joints_at_tangent_points(profile_for_revolve, profile_height, s=1, angle=90) {
...
module test_sweep_place_revolve_joints_at_endpoints(profile_for_revolve, profile_height, s=1, angle=180) {

}

// ===== ORNAMENT SWEEP PATTERN =====
// Sweep all ornament entities with given profile at scale s
module test_sweep_sweep_pattern_button_generator(profile, s=1) {
    union() {
        // Sweep lines
    ...
    difference() {
        union() {
            ...
            difference() {
                union() {
                    color("gold")
                    test_sweep_sweep_pattern_button_generator(
                    ...
                    color("gold")
                    test_sweep_place_revolve_joints_at_tangent_points(
                    ...
                    color("gold")
                    test_sweep_place_revolve_joints_at_endpoints(
                        p_4_for_revolve_scaled(s=n_scl_profile),
                        p_4_height * n_scl_profile,
                        s=s,
                        angle=180
