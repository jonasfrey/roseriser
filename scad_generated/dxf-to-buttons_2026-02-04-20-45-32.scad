...
// Entities: 0 lines, 13 arcs, 1 circles
...
arc_0 = [[-3.289247, -1.899047], 2.900635, 210.000000, 390.000000];
arc_1 = [[-8.313294, -4.799682], 2.900635, 210.000000, 390.000000];
arc_2 = [[0.000000, 9.599365], 2.900635, 90.000000, 270.000000];
arc_3 = [[8.313294, -4.799682], 2.900635, 330.000000, 510.000000];
arc_4 = [[3.289247, -1.899047], 2.900635, 330.000000, 510.000000];
arc_5 = [[-5.801270, -3.349365], 5.801270, 210.000000, 420.000000];
arc_6 = [[0.000000, 6.698730], 5.801270, 90.000000, 300.000000];
arc_7 = [[5.801270, -3.349365], 5.801270, 330.000000, 540.000000];
circle_0 = [[0.000000, -0.000000], 12.500000];
arc_8 = [[0.000000, 6.698730], 5.801270, 90.000000, 240.000000];
arc_9 = [[0.000000, 6.698730], 5.801270, 240.000000, 300.000000];
arc_10 = [[5.801270, -3.349365], 5.801270, 330.000000, 480.000000];
arc_11 = [[-0.000000, 0.000000], 12.500000, 330.000000, 450.000000];
arc_12 = [[0.000000, 3.798095], 2.900635, 90.000000, 270.000000];
...
tangent_point_0 = [-5.801270, -3.349365, 0];
tangent_point_0_angle = -60.000000;
tangent_point_1 = [-10.825318, -6.250000, 0];
tangent_point_1_angle = -60.000000;
tangent_point_2 = [-0.000000, 12.500000, 0];
tangent_point_2_angle = -180.000000;
tangent_point_3 = [0.000000, 6.698730, 0];
tangent_point_3_angle = 180.000000;
tangent_point_4 = [5.801270, -3.349365, 0];
tangent_point_4_angle = 60.000000;
tangent_point_5 = [10.825318, -6.250000, 0];
tangent_point_5_angle = 60.000000;
tangent_point_6 = [-2.900635, 1.674682, 0];
tangent_point_6_angle = -30.000000;
tangent_point_7 = [2.900635, 1.674682, 0];
tangent_point_7_angle = -150.000000;
...
endpoint_0_angle = 480.000000;
endpoint_1 = [0.777223, -0.448730, 0];
endpoint_1_angle = 600.000000;
endpoint_2 = [0.000000, -3.349365, 0];
endpoint_2_angle = 630.000000;
endpoint_3 = [0.000000, 0.897460, 0];
endpoint_3_angle = 360.000000;
...
module but_s1_v2_place_revolve_joints_at_tangent_points(profile_for_revolve, profile_height, s=1, angle=90) {
...
module but_s1_v2_place_revolve_joints_at_endpoints(profile_for_revolve, profile_height, s=1, angle=180) {
...
module but_s1_v2_sweep_pattern_button_generator(profile, s=1) {
    union() {
        // Sweep lines
        ...
        sweep_arc_button_generator(profile, scale_arc_button_generator(arc_12, s), n_segments=32);
    ...
    difference() {
        union() {
            ...
            difference() {
                union() {
                    color("gold")
                    but_s1_v2_sweep_pattern_button_generator(
                    ...
                    color("gold")
                    but_s1_v2_place_revolve_joints_at_tangent_points(
                    ...
                    color("gold")
                    but_s1_v2_place_revolve_joints_at_endpoints(
                        p_4_for_revolve_scaled(s=n_scl_profile),
                        p_4_height * n_scl_profile,
                        s=s,
                        angle=180
