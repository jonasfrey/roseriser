...
// Entities: 0 lines, 6 arcs, 4 circles
...
arc_0 = [[8.313294, -4.799682], 2.900635, 150.000000, 330.000000];
circle_0 = [[0.000000, 0.000000], 12.500000];
arc_1 = [[3.289247, -1.899047], 2.900635, 330.000000, 510.000000];
circle_1 = [[0.000000, 6.698730], 5.801270];
arc_2 = [[-8.313294, -4.799682], 2.900635, 30.000000, 210.000000];
arc_3 = [[0.000000, 9.599365], 2.900635, 270.000000, 450.000000];
circle_2 = [[5.801270, -3.349365], 5.801270];
arc_4 = [[0.000000, 3.798095], 2.900635, 90.000000, 270.000000];
arc_5 = [[-3.289247, -1.899047], 2.900635, 210.000000, 390.000000];
circle_3 = [[-5.801270, -3.349365], 5.801270];
...
tangent_point_0_angle = -120.000000;
tangent_point_1 = [-5.801270, -3.349365, 0];
tangent_point_1_angle = 120.000000;
tangent_point_2 = [-0.000000, 6.698730, 0];
tangent_point_2_angle = -0.000000;

// ===== UNCONNECTED ENDPOINTS (centered at origin) =====
// Points where entities have no connection, with outward rotation angle
endpoint_0 = [10.825318, -6.250000, 0];
endpoint_0_angle = 420.000000;
endpoint_1 = [0.777223, -0.448730, 0];
endpoint_1_angle = 600.000000;
endpoint_2 = [-10.825318, -6.250000, 0];
endpoint_2_angle = 300.000000;
endpoint_3 = [0.000000, 12.500000, 0];
endpoint_3_angle = 540.000000;
endpoint_4 = [-0.000000, 0.897460, 0];
endpoint_4_angle = 360.000000;
endpoint_5 = [-0.777223, -0.448730, 0];
endpoint_5_angle = 480.000000;
...
module but_s1_v5_place_revolve_joints_at_tangent_points(profile_for_revolve, profile_height, s=1, angle=90) {
...
module but_s1_v5_place_revolve_joints_at_endpoints(profile_for_revolve, profile_height, s=1, angle=180) {
...
module but_s1_v5_sweep_pattern_button_generator(profile, s=1) {
    union() {
        // Sweep lines
        ...
        sweep_circle_button_generator(profile, scale_circle_button_generator(circle_1, s), n_segments=32);
        sweep_circle_button_generator(profile, scale_circle_button_generator(circle_2, s), n_segments=32);
        sweep_circle_button_generator(profile, scale_circle_button_generator(circle_3, s), n_segments=32);
    }
}
    ...
    difference() {
        union() {
            ...
            difference() {
                union() {
                    color("gold")
                    but_s1_v5_sweep_pattern_button_generator(
                    ...
                    color("gold")
                    but_s1_v5_place_revolve_joints_at_tangent_points(
                    ...
                    color("gold")
                    but_s1_v5_place_revolve_joints_at_endpoints(
                        p_4_for_revolve_scaled(s=n_scl_profile),
                        p_4_height * n_scl_profile,
                        s=s,
                        angle=180
