...
o_wsmsg__generate_scad.f_v_server_implementation = async function(o_wsmsg){
    let { s_generation_type, n_id__profile, n_id__profile_remover, n_id__path, n_point_per_mm, s_sweep_function, b_mirror_side_override, b_flip_y } = o_wsmsg.v_data;
    ...
    if(s_generation_type === 'profile_revolve'){
        ...
        s_scad = f_s_scad__generate_simple(o_dxffile__profile, f_get(n_id__path), n_point_per_mm, false, s_sweep_function, b_mirror_side_override, b_flip_y);
    } else if(s_generation_type === 'simple_endpoints'){
        s_scad = f_s_scad__generate_simple(o_dxffile__profile, f_get(n_id__path), n_point_per_mm, true, s_sweep_function, b_mirror_side_override, b_flip_y);
    } else if(s_generation_type === 'simple_endpoints_joints'){
        s_scad = f_s_scad__generate_simple_joints(o_dxffile__profile, f_get(n_id__path), n_point_per_mm, s_sweep_function, b_mirror_side_override, b_flip_y);
    } else if(s_generation_type === 'simple_endpoints_joints_remover'){
        s_scad = f_s_scad__generate_simple_joints_remover(o_dxffile__profile, f_get(n_id__profile_remover), f_get(n_id__path), n_point_per_mm, s_sweep_function, b_mirror_side_override, b_flip_y);
    }
